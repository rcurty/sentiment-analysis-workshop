...
Let's go back and apply tokenization to our normalized dataset:
...
Alright! Is everything clear so far? We’ve now tokenized each comment (or row of text) in our dataset into multiple individual tokens. Right now we have 124,864 tokens!

But you may have noticed that some tokens are actually irrelevant words; something we’ll tackle in the next step.
