...
We can generate a summary output for each emotion by running:
...
We could continue exploring the data a in multiple ways, specially if we had the demographics associated with each comment, but that should be good enough to call it the day.
