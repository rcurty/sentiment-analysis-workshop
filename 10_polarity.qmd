...
Let's now take a look at the `sentiment_scores` dataframe:
...
That’s only part of the story. Now we move on to emotion detection to discover what else we can learn from the data,
