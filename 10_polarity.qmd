...
In summary, this package, Each word in a sentence is checked against a dictionary of positive and negative words, like the Jockers dictionary in the lexicon package. Words that are positive get a +1, and words that are negative get a -1. We call these **polarized words**.
...
Punctuation like commas, colons, and semicolons is taken into account because it can separate ideas. The main polarized word’s sentiment is then adjusted by the surrounding words. Amplifiers make it stronger, de-amplifiers make it weaker, and negators can flip the sentiment. Multiple negators can cancel each other out, like “not unhappy” turning positive. <!--# consideration to bring back punctuation????-->
