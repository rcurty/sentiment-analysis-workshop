...
The running example draws on publicly available data from profiles on X (formerly Twitter). Specifically, we collected all posts from the first and second days following the season finales of both Season 1 and Season 2 of the Apple TV series \[*Severance*\](https://en.wikipedia.org/wiki/Severance\_(TV_series).
...
Access this folder <add Link>, ensure to download it, and save in an easy to locate place (e.g., Desktop).
