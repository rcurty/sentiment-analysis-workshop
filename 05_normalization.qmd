...
We have created multiple intermediated columns to facilitate the
...
Now we are finally ready to move to the preprocessing phase, let's see
what that steps that entails.
